...
export default async function OverOnsPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Over ons"
        h1="Gespecialiseerd in vergunningtekeningen voor keukenuitbouwen"
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <Reveal delay={100} className="mt-8 space-y-5 text-brand-ink-muted">
            <p>
              ...
              zich specifiek richt op vergunningtekeningen voor keukenuitbouwen.
            </p>
            <p>
              Die specialisatie maakt het verschil: bij een uitbouw breekt u de bestaande
              achtergevel open, en dat is bouwkundig iets anders dan een aanbouw zonder
              gevelopening. Zeker als er een dragende muur bij betrokken is, moet de constructie
              goed worden onderbouwd. Doordat we dagelijks met dit type project werken, weten we
              precies waar een toetser op let en waar een
