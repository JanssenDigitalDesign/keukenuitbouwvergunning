// An expanding-room pictogram (existing volume + glass extension) instead
// of the plain roofline used on the other JDD sites — this is the
// keukenuitbouw brand.
export function BrandIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M13.5 20h4a2.5 2.5 0 0 0 2.5-2.5V12" stroke="currentColor" strokeWidth="1.4" strokeDasharray="1.6 1.8" />
      <path d="M14 8h6M14 8v6" stroke="currentColor" strokeWidth="1.6" />
      <path d="M6.5 12h5M6.5 15h5" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  );
}
